...
<body>
	<form id="myForm" method="post" action="${ctx}/role/add">
		<table>
			<tr>
			...
			<tr>
				<td colspan="4" align="right"><a href="#"
					...
					onclick="ev_validateAndSave('角色管理','${ctx}/role/add')">提交</a> <a
					href="#" id="btn" class="easyui-linkbutton" iconCls="icon-cancel"
					onclick="ev_cancel()">取消</a></td>
			</tr>
